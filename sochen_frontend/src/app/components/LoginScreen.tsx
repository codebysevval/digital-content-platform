    ...
    <div className="w-full">
      <div className="relative w-full">
        ...
        <div className="bg-[#1a2332] border border-white/5 rounded-2xl p-8">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                    required={isSignUp}
                  />
                </div>
              </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#1a2332] text-gray-500">veya</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 text-gray-300 font-medium py-3 rounded-lg hover:bg-white/10 transition-all"
            >
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          {isSignUp ? 'Kayıt olarak ' : 'Giriş yaparak '}
